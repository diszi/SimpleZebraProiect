...
public class Main2Activity  extends AppCompatActivity implements IOnScannerEvent {

    // Create tag for logging purposes
    private final static String TAG = "[Z] Main2Activity - ";
    ...
    public void onStop() {
        ...
        //upon resume from a screen suspend, onDestroy method doesn't run therefore releasing EMDK here
